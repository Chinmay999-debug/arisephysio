...
const appCss = "/arisephysio/assets/styles-Xh2dBv5t.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Arise Physiotherapy — Move Again. Live Fully." },
      { name: "description", content: "Premium physiotherapy clinic delivering evidence-based recovery, sports rehab, and pain relief. Book your assessment today." },
      { name: "author", content: "Arise Physiotherapy" },
      { property: "og:title", content: "Arise Physiotherapy — Move Again. Live Fully." },
      { property: "og:description", content: "Evidence-based recovery, sports rehab, and pain relief by specialist physiotherapists." },
...
const $$splitComponentImporter = () => import("./index-DZGGwkRW.js");
