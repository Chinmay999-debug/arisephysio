...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Ds_yef9B.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BrtGAotJ.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "arisephysio";
var SERVER_FN_BASE = "/arisephysio/_serverFn/";
